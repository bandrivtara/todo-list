...
export const AddTaskItem = () => {
    return (
        <Fragment>
            <div className="task-item add-task-item">
                <div className="checkbox-container">
                    <svg width="23" height="21" viewBox="0 0 25 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <div className="button-group">
                <button className="btn orange-color">CANCEL</button>
